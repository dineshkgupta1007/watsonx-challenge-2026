$raw = Get-Content "C:\Users\DINESHGUPTA\Desktop\watsonx challenge 2026\.bob\tmp\xlsx-dumps\Ind July month 30 days demands-96dcc4d4fac9a7d4\30days.json" -Raw | ConvertFrom-Json
$headers = $raw.headers
$rows    = $raw.rows
...
$out = $sb.ToString()
$outPath = Join-Path (Split-Path $PSScriptRoot -Parent | Split-Path -Parent) "IND_July2026_Compliance_by_FS.html"
# write relative to workspace root
$outPath = "C:\Users\DINESHGUPTA\Desktop\watsonx challenge 2026\IND_July2026_Compliance_by_FS.html"
